        ...
        <tbody>
            ...
            <tr class="prop">
                ...
                <td class="value">
                        <div>
                            <label>
                                <g:radio name="importType" value="category" checked="${params.type=='category'}"/>
                        ...
                        <div>
                            <label>
                                <g:radio name="importType" value="product" checked="${params.type=='product'}"/>
                        ...
                        <div>
                            <label>
                                <g:radio name="importType" value="inventory" checked="${params.type=='inventory'}"/>
                        ...
                        <div>
                            <label>
                                <g:radio name="importType" value="inventoryLevel" checked="${params.type=='inventoryLevel'}"/>
                        ...
                        <div>
                            <label>
                                <g:radio name="importType" value="location" checked="${params.type=='location'}"/>
                        ...
                        <div>
                            <label>
                                <g:radio name="importType" value="person" checked="${params.type=='person'}"/>
                        ...
                        <div>
                            <label>
                                <g:radio name="importType" value="productCatalog" checked="${params.type=='productCatalog'}"/>
                        ...
                        <div>
                            <label>
                                <g:radio name="importType" value="productCatalogItem" checked="${params.type=='productCatalogItem'}"/>
                        ...
                        <div>
                            <label>
                                <g:radio name="importType" value="productSupplier" checked="${params.type=='productSupplier'}"/>
                        ...
                        <div>
                            <label>
                                <g:radio name="importType" value="tag" checked="${params.type=='tag'}"/>
                        ...
                        <div>
                            <label>
                                <g:radio name="importType" value="user" checked="${params.type=='user'}"/>
                        ...
                        <div>
                            <label>
                                <g:radio name="importType" value="userLocation" checked="${params.type=='userLocation'}"/>
